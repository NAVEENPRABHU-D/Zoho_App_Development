...
public class ATM {
    ...
    public static void admin() {
        ...
        int adop = 0;
        if (adminName.equals("Naveen") && adminPassword == 12345) {
            do {
    ...
    public static void main(String[] args) {
        u[0] = new userdetails("Naveen",1155,52300,"U1014");
        u[1] = new userdetails("Karthick",1144,72300,"U1024");
        u[2] = new userdetails("Kumar",1133,62300,"U1077");
        u[3] = new userdetails("Priya",1122,42300,"U1092");
        int ch = 0;
        do {
            System.out.println("Welcome");
